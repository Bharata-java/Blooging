...
public class SwaggerConfiguration {
	...
	private ApiInfo getInfo() {
		return new ApiInfo("Blogging Application", "This project is developed by G.BHARATA", "1.0",
				"Terms of Service", new Contact("BHARATA", "Nil", "bharatagujari@gmail.com"), "License of use",
